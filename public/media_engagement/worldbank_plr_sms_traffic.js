...
const update = (data) => {
    ...
    const lastTimeStampDataUpdate = new Date(Math.max.apply(null, data.map(function(d) {
    ...
    function setLastUpdatedAlert() {
        ...
        var difference_ms = (currentTime.getTime() - lastTimeStampDataUpdate.getTime())/60000
